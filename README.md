...
| ---------------------------------------------------------------------------------- | ------------------------------------------- | ------- |
| [Add-DiaCrossShapeLine](/Docs/dev-guide/commands/Add-DiaCrossShapeLine.md)         | Adds a line between two cross shapes        | 0.2.31  |
| [Add-DiaNodeIcon](/Docs/dev-guide/commands/Add-DiaNodeIcon.md)                     | Adds an icon to a node                      | 0.2.31  |
| [Add-DiaHTMLLabel](/Docs/dev-guide/commands/Add-DiaHTMLLabel.md)                   | Adds an HTML label to the diagram           | 0.2.31  |
| [Add-DiaHTMLNodeTable](/Docs/dev-guide/commands/Add-DiaHTMLNodeTable.md)           | Adds an HTML node table to the diagram      | 0.2.31  |
| [Add-DiaHtmlSignatureTable](/Docs/dev-guide/commands/Add-DiaHtmlSignatureTable.md) | Adds an HTML signature table to the diagram | 0.2.31  |
| [Add-DiaHTMLSubGraph](/Docs/dev-guide/commands/Add-DiaHTMLSubGraph.md)             | Adds an HTML subgraph to the diagram        | 0.2.31  |
| [Add-DiaHTMLTable](/Docs/dev-guide/commands/Add-DiaHTMLTable.md)                   | Adds an HTML table to the diagram           | 0.2.31  |
| [Add-DiaInvertedLShapeLine](/Docs/dev-guide/commands/Add-DiaInvertedLShapeLine.md) | Adds a line between two inverted L shapes   | 0.2.31  |
| [Add-DiaInvertedTShapeLine](/Docs/dev-guide/commands/Add-DiaInvertedTShapeLine.md) | Adds a line between two inverted T shapes   | 0.2.31  |
| [Add-DiaLeftLShapeLine](/Docs/dev-guide/commands/Add-DiaLeftLShapeLine.md)         | Adds a line between two left L shapes       | 0.2.31  |
| [Add-DiaLeftTShapeLine](/Docs/dev-guide/commands/Add-DiaLeftTShapeLine.md)         | Adds a line between two left T shapes       | 0.2.31  |
| [Add-DiaLShapeLine](/Docs/dev-guide/commands/Add-DiaLShapeLine.md)                 | Adds a line between two L shapes            | 0.2.31  |
| [Add-DiaNodeImage](/Docs/dev-guide/commands/Add-DiaNodeImage.md)                   | Adds an image to a node                     | 0.2.31  |
| [Add-DiaNodeShape](/Docs/dev-guide/commands/Add-DiaNodeShape.md)                   | Adds a shape to a node                      | 0.2.31  |
| [Add-DiaNodeSpacer](/Docs/dev-guide/commands/Add-DiaNodeSpacer.md)                 | Adds a spacer to a node                     | 0.2.31  |
| [Add-DiaRightLShapeLine](/Docs/dev-guide/commands/Add-DiaRightLShapeLine.md)       | Adds a line between two right L shapes      | 0.2.31  |
| [Add-DiaRightTShapeLine](/Docs/dev-guide/commands/Add-DiaRightTShapeLine.md)       | Adds a line between two right T shapes      | 0.2.31  |
| [Add-DiaTShapeLine](/Docs/dev-guide/commands/Add-DiaTShapeLine.md)                 | Adds a line between two T shapes            | 0.2.31  |
| [Add-DiaVerticalLine](/Docs/dev-guide/commands/Add-DiaVerticalLine.md)             | Adds a vertical line between two nodes      | 0.2.31  |
| [Export-Diagrammer](/Docs/dev-guide/commands/Export-Diagrammer.md)                 | Exports the diagram to a file               | 0.2.31  |
| [Get-RandomColorHex](/Docs/dev-guide/commands/Get-RandomColorHex.md)               | Gets a random color in hex format           | 0.2.31  |
| [Get-RandomPastelColorHex](/Docs/dev-guide/commands/Get-RandomPastelColorHex.md)   | Gets a random pastel color in hex format    | 0.2.31  |
| [New-Diagrammer](/Docs/dev-guide/commands/New-Diagrammer.md)                       | Creates a new diagram from an input object  | 0.2.31  |
