...
### EXAMPLE 1
```powershell
Add-DiaNodeText -Name "Server1" -TableBorder 2 -TableBorderColor "#FF0000" -TableBorderStyle "SOLID" -Text "This is a test text box." -FontColor "#0000FF" -FontSize 14 -FontBold -TableBackgroundColor "#FFFF00" -NodeObject
```
...
!!! example
    === "Example 1"
        ...
        ```graphviz dot AddDiaNodeText.png
            digraph g {
                node [shape=plain];
                "Server1" [shape="plain";fontsize="14";label=<<TABLE STYLE='SOLID' bgcolor='#FFFF00' border='2' color='#FF0000' cellborder='0' cellspacing='5' cellpadding='5'><TR><TD STYLE='SOLID' ALIGN='Center' colspan='1'><FONT FACE='Segoe Ui' POINT-SIZE='14' COLOR='#0000FF'><B>This is a test text box.</B></FONT></TD></TR></TABLE>>;fillcolor="transparent";]
            }
        ```
    === "Example 1 - DraftMode"

        ```graphviz dot AddDiaNodeText_draftmode.png
            digraph g {
                node [shape=plain];
                "Server1" [shape="plain";fontsize="14";label=<<TABLE bgcolor='#FFCCCC' color='red' border='1' cellborder='0' cellspacing='5' cellpadding='5'><TR><TD STYLE='SOLID' ALIGN='Center' colspan='1'><FONT FACE='Segoe Ui' POINT-SIZE='14' COLOR='#0000FF'><B>This is a test text box.</B></FONT></TD></TR></TABLE>>;fillcolor="transparent";]
            }
        ```

### EXAMPLE 2
```powershell
Add-DiaNodeText -Name "Server1" -TableBorder 2 -TableBorderColor "#FF0000" -TableBorderStyle "SOLID" -Text "This is a test text box.\n with multiple lines." -FontColor "#0000FF" -FontSize 14 -FontBold -TableBackgroundColor "#FFFF00" -NodeObject
```

This command creates a text box node named "Server1" with a solid red border of 2 pixels, blue bold text of size 14, and a yellow background. The text box contains multiple lines, with a line break between "This is a test text box." and "with multiple lines.". The `\n` in the text parameter is converted to `<BR/>` in the HTML representation.
...
!!! example
    === "Example 2"
        ...
        ```graphviz dot AddDiaNodeText.png
            digraph g {
                node [shape=plain];
                "Server1" [shape="plain";fontsize="14";label=<<TABLE STYLE='SOLID' bgcolor='#FFFF00' border='2' color='#FF0000' cellborder='0' cellspacing='5' cellpadding='5'><TR><TD STYLE='SOLID' ALIGN='Center' colspan='1'><FONT FACE='Segoe Ui' POINT-SIZE='14' COLOR='#0000FF'><B>This is a test text box.<BR/> with multiple lines.</B></FONT></TD></TR></TABLE>>;fillcolor="transparent";]
            }
        ```
    === "Example 2 - DraftMode"
        ...
        ```graphviz dot AddDiaNodeText_draftmode.png
            digraph g {
                node [shape=plain];
                "Server1" [shape="plain";fontsize="14";label=<<TABLE bgcolor='#FFCCCC' color='red' border='1' cellborder='0' cellspacing='5' cellpadding='5'><TR><TD STYLE='SOLID' ALIGN='Center' colspan='1'><FONT FACE='Segoe Ui' POINT-SIZE='14' COLOR='#0000FF'><B>This is a test text box.<BR/> with multiple lines.</B></FONT></TD></TR></TABLE>>;fillcolor="transparent";]
            }
        ```
