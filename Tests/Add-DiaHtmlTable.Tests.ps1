...
Describe Add-DiaHtmlTable {
    ...
    It "Should return a single column HTML table" {
        $HTMLSingleColumn | Should -BeExactly '<TABLE PORT="EdgeDot" STYLE="" BORDER="0" CELLBORDER="0" CELLSPACING="5" CELLPADDING="5" BGCOLOR="#ffffff" COLOR="#000000"><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.5.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.7.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">10.0.0.0/24</FONT></TD></TR></TABLE>'
    }
    It "Should return a single column HTML table with draftmode enabled" {
        $HTMLSingleColumnDebug | Should -BeExactly '<TABLE PORT="EdgeDot" STYLE="" BORDER="1" CELLBORDER="0" CELLSPACING="5" CELLPADDING="5" BGCOLOR="#ffffff" COLOR="red"><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.5.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.7.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">10.0.0.0/24</FONT></TD></TR></TABLE>'
    }
    It "Should return a multi column HTML table" {
        $HTMLMultiColumn | Should -BeExactly '<TABLE PORT="EdgeDot" STYLE="" BORDER="0" CELLBORDER="0" CELLSPACING="5" CELLPADDING="5" BGCOLOR="#ffffff" COLOR="#000000"><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.5.0/24</FONT></TD><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.7.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">10.0.0.0/24</FONT></TD></TR></TABLE>'
    }
    It "Should return a multi column HTML table with draftmode enabled" {
        $HTMLMultiColumnDebug | Should -BeExactly '<TABLE PORT="EdgeDot" STYLE="" BORDER="1" CELLBORDER="0" CELLSPACING="5" CELLPADDING="5" BGCOLOR="#ffffff" COLOR="red"><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.5.0/24</FONT></TD><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">192.68.7.0/24</FONT></TD></TR><TR><TD ALIGN="Center" COLSPAN="1"><FONT FACE="Segoe Ui" POINT-SIZE="14" COLOR="#000000">10.0.0.0/24</FONT></TD></TR></TABLE>'
    }
}