...
Describe "Get-DiaHTMLNodeTable" {
    It "Returns a multi column HTML table with icon image at each cell" {
    ...
    It "Returns a multi column HTML table with ICON text at each cell in debug mode" {
    ...
    It "Returns a single column HTML table with ICON at top cell" {
    ...
    It "Returns a single column HTML table with ICON at top cell in debug mode" {
