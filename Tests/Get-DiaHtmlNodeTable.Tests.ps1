...
Describe "Get-DiaHTMLNodeTable" {
    ...
    It "Should returns a multi column HTML table with ICON text at each cell in debug mode" {
    ...
    It "Should returns a single column HTML table with ICON at top cell" {
    ...
    It "Should returns a single column HTML table with ICON at top cell in debug mode" {
