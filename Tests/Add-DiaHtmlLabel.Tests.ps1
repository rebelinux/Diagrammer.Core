...
Describe Add-DiaHtmlLabel {
    ...
    Context "Display Label with Icon" {
        It "Should return a HTML Table with an Icon at Top and a Label text at bottom (Vertical Alignment)" {
            $HTMLTableMainLabel | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='20' cellpadding='10'><TR><TD ALIGN='center' colspan='1'><img src='Diagrammer.png'/></TD></TR><TR><TD ALIGN='center'><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
    ...
    Context "Display Label with Icon in Subgraph form (fits better in Subgraph)" {
        It "Should return a HTML Table with an Icon at left and a Label text at right (Horizontal Alignment)" {
            $HTMLTableSubgraphLabel | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='5' cellpadding='5'><TR><TD ALIGN='center' colspan='1'><img src='Diagrammer.png'/></TD><TD ALIGN='center'><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
        It "Should return a HTML Table with an Icon at left and a Label text at right (Horizontal Alignment) in Draftmode" {
            $HTMLTableSubgraphLabelDraftmode | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='20' cellpadding='20'><TR><TD bgcolor='#FFCCCC' ALIGN='center' colspan='1'>Subgraph Logo</TD><TD bgcolor='#FFCCCC' ALIGN='center'><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
    }
    ...
    Context "Display Label with Icon with custom Width and Height calculated in Percent of original image size" {
        It "Should return a HTML Table with an Icon at Top and a Label text at bottom (Vertical Alignment) with custom Icon size in Percent" {
            $HTMLTableMainLabelSetImagePercent | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='20' cellpadding='10'><TR><TD ALIGN='center' colspan='1' fixedsize='true' width='90' height='61.5'><img src='Diagrammer.png'/></TD></TR><TR><TD ALIGN='center'><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
    ...
    Context "Display Label without Icon" {
        It "Should return a HTML Table with an Icon at Top and a Label text at bottom (Vertical Alignment)" {
            $HTMLTableMainLabelNoIcon | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='20' cellpadding='20'><TR><TD ALIGN='center' ><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
        It "Should return a HTML Table with an Icon at Top and a Label text at bottom (Vertical Alignment) in Draftmode" {
            $HTMLTableSubgraphLabelNoIcon | Should -BeExactly "<TABLE border='0' cellborder='0' cellspacing='20' cellpadding='20'><TD ALIGN='center'><FONT FACE='Segoe Ui' Color='#565656' POINT-SIZE='14'>Active Directory Forest Diagram</FONT></TD></TR></TABLE>"
        }
    }
